...
- **What this repo owns:** project-specific Dockerfile, `.sandcastle/main.mts` thin wiring, prompt overrides, repo-specific skills, domain code, `GOALS.md` (north star — read first), `CONTEXT.md` (domain glossary), ADRs, `.env`.
